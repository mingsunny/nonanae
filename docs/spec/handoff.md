...
- **게스트 재입장 인증(PIN) 방식 미확인** (2026-09-12): sep10 프로토타입은 기존에 결정됐던 "닉네임+PIN(5회 실패 시 잠금)" 재입장 인증 없이, 로그인 안 한 참가자가 이름만 입력하면 참여되는 방식으로 단순화돼 있음. 이게 정식 결정인지 확인 필요 — 확인되면 [06-join-group.md](06-join-group.md), [07-join-match.md](07-join-match.md), [09-group-settle.md](09-group-settle.md), [12-group-invite.md](12-group-invite.md), `conventions.md`, `schema.md`(Member.pinHash 등)를 함께 정리해야 함.
...
- **참가자 비로그인 참여(게스트) 결정 반영 필요** (2026-09-06): 참가자는 정식 로그인 없이도 참여할 수 있도록 결정됨(구체적인 재입장 인증 방식은 위 항목 참고). [01-login.md](01-login.md), [02-onboarding.md](02-onboarding.md), [03-group-list.md](03-group-list.md), [04-profile.md](04-profile.md)는 이 기준으로 업데이트 완료. [06-join-group.md](06-join-group.md), [07-join-match.md](07-join-match.md), [09-group-settle.md](09-group-settle.md), [12-group-invite.md](12-group-invite.md)는 담당자가 작성 시 반드시 확인해야 할 내용을 문서 상단에 콜아웃으로 남겨둠. 공통 개념/비교표는 [conventions.md](conventions.md#정식-회원--게스트-참가자) 참고.
