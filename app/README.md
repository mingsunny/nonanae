...
| 4 | 회원 탈퇴 · 비밀번호 재설정 | 연결됨. 탈퇴는 `supabase/migrations/20260921000000_delete_account.sql`을 Supabase에 적용해야 동작한다. 재설정 메일 링크가 돌아올 주소를 Supabase URL Configuration에 등록해야 한다 |
